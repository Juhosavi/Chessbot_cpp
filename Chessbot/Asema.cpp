...
void Asema::anna_tornin_raakasiirrot(int rivi, int linja, int pelaaja, std::vector<Siirto>& siirrot) const
{
    ...
    //Ylˆsp‰in: Rivinumero pienenee, eli siirryt‰‰n rivilt‰ rivi-1 kohti nollaa, kunnes tˆrm‰t‰‰n esteeseen.
    //Alasp‰in: Rivinumero kasvaa, eli siirryt‰‰n rivilt‰ rivi + 1 kohti 7 : ‰‰, kunnes tˆrm‰t‰‰n esteeseen.
    //Vasemmalle : Sarake(linja) pienenee, eli siirryt‰‰n sarakkeelta linja - 1 kohti nollaa, kunnes tˆrm‰t‰‰n esteeseen.
    //Oikealle : Sarake(linja) kasvaa, eli siirryt‰‰n sarakkeelta linja + 1 kohti 7 : ‰‰, kunnes tˆrm‰t‰‰n esteeseen.

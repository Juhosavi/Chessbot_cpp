...
void Asema::anna_kuningas_raakasiirrot(int rivi, int linja, int pelaaja, std::vector<Siirto>& siirrot) const
{
    ...
    //lisää linnoitus siirto kutsutaan siirto generaattorista vasta raakasiirrot jälkeen 
    //linnoituksen lisääminen erikseen anna kaikki raakasiirrot sen jälkeen 
}
